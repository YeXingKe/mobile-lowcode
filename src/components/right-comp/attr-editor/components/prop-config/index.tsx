...
import { VisualEditorPropsType, type VisualEditorProps } from '@/utils/visual-editor-props'
...
import type { VisualEditorBlockData, VisualEditorComponent } from '@/utils/visual-editor'
